...
class DepthEstimationPipeline(DiffusionPipeline):
    ...
    def __call__(self,
        ...
        if ensemble_size > 1:
            ...
            pred_uncert = None
        print('done testtime ensembling')
        # ----------------- Post processing -----------------
