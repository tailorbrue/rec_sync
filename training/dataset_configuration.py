...
# Get Dataset Here
def prepare_dataset(gt_datapath=None,
                    rgb_datapath=None,
                    train_detpthgt_list=None,
                    train_rgb_list=None,
                    batch_size=1,
                    test_batch=1,
                    datathread=4,
    ...
    # TODO: update items in StereoDataset
    train_dataset = StereoDataset(train_gt_dir=gt_datapath, train_rgb_dir=rgb_datapath, train_depthgt_list=train_detpthgt_list,
                                  train_rgb_list=train_rgb_list, mode='train', transform=train_transform)
